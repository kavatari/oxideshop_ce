...
- Wrong language keys from `\OxidEsales\EshopCommunity\Core\Language::_getConfigLanguageValues` method. [PR-647](https://github.com/OXID-eSales/oxideshop_ce/pull/647)
